							...
							<form action="User" class="form-horizontal" method="POST">
								<fieldset>
									<input type="hidden" name="task"
										value="CUSTOMER_CHANGE_PASSWORD" />
						...
						<div class="well">
							<form action="User" class="form-horizontal" method="POST">
								<fieldset>
									...
									<div class="form-group">
										<label class="col-sm-4 control-label">Verify new email
											address: </label>
										<div class="col-sm-8">
											<input type="email" name="verify_email" /><br>
										</div>
									</div>
						...
						<div class="well">
							<form action="User" class="form-horizontal" method="POST">
								<fieldset>
									...
									<div class="form-group">
										<label class="col-sm-4 control-label">New address:</label>
										<div class="col-sm-8">
											<input type="text" name="new_address" /><br>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="col-sm-4 control-label">Verify new
											address:</label>
										<div class="col-sm-8">
											<input type="text" name="verify_address" /><br>
										</div>
									</div>
